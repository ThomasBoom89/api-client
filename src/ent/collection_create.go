...
func (cc *CollectionCreate) SetNillableName(s *string) *CollectionCreate {
	if s != nil {
		cc.SetName(*s)
	}
	return cc
...
func (cc *CollectionCreate) SetProjectID(i int) *CollectionCreate {
	cc.mutation.SetProjectID(i)
	return cc
}

// AddRequestIDs adds the "requests" edge to the Request entity by IDs.
func (cc *CollectionCreate) AddRequestIDs(ids ...int) *CollectionCreate {
	cc.mutation.AddRequestIDs(ids...)
	return cc
}

// AddRequests adds the "requests" edges to the Request entity.
func (cc *CollectionCreate) AddRequests(r ...*Request) *CollectionCreate {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
...
func (cc *CollectionCreate) SetProject(p *Project) *CollectionCreate {
...
func (cc *CollectionCreate) check() error {
	...
	if _, ok := cc.mutation.ProjectID(); !ok {
		return &ValidationError{Name: "project_id", err: errors.New(`ent: missing required field "Collection.project_id"`)}
	}
	if _, ok := cc.mutation.ProjectID(); !ok {
		return &ValidationError{Name: "project", err: errors.New(`ent: missing required edge "Collection.project"`)}
	}
	return nil
}
